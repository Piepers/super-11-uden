...
/**
 * The standing as it is retrieved per stage. Contains the standing of a
 * particular stage for a league. This object lacks the "_id" field and
 * therefore doesn't extend the {@link SportdeerDomainObject}. It is very
...
public class Standing {
	...
	public Standing(@JsonProperty("id_team_season") Long teamSeasonId,
	...
	public String toString() {
		return "Standing [teamSeasonId=" + this.teamSeasonId + ", teamSeasonName=" + this.teamSeasonName + ", played="
				+ this.played + ", winsHome=" + this.winsHome + ", drawsHome=" + this.drawsHome + ", lossesHome="
				+ this.lossesHome + ", winsAway=" + this.winsAway + ", drawsAway=" + this.drawsAway + ", lossesAway="
				+ this.lossesAway + ", goalsScoredHome=" + this.goalsScoredHome + ", goalsAwayHome="
				+ this.goalsAwayHome + ", goalsScoredAway=" + this.goalsScoredAway + ", goalsAwayAway="
				+ this.goalsAwayAway + ", points=" + this.points + ", winsTotal=" + this.winsTotal + ", drawsTotal="
				+ this.drawsTotal + ", lossesTotal=" + this.lossesTotal + ", goalsTotal=" + this.goalsTotal
				+ ", goalsAwayTotal=" + this.goalsAwayTotal + ", goalDifferenceHome=" + this.goalDifferenceHome
				+ ", goalDifferenceAway=" + this.goalDifferenceAway + ", goalDifferenceTotal="
